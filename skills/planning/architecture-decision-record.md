...
## Purpose
Run the `architecture-decision-record` procedure inside the permission and context of the calling agent.
...
## Write Impact
Workspace artifacts: YES; Product Code: NO
...
## Review Mapping
R01 PLANNING_QUALITY; R02 risk gate when impact is high
