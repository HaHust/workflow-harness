...
## Purpose
Run the `database-migration-review` procedure inside the permission and context of the calling agent.
...
## Write Impact
Risk review artifact only; Product/Test/Knowledge writes: NO
