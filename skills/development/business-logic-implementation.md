...
## Purpose
Run the `business-logic-implementation` procedure inside the permission and context of the calling agent.
...
## Write Impact
Product Code: conditional; Documentation: conditional; Test Code: NO unless explicitly assigned
...
## Review Mapping
R01 CODE_CORRECTNESS; R02 risk gate when applicable
