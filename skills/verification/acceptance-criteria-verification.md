...
## Purpose
Run the `acceptance-criteria-verification` procedure inside the permission and context of the calling agent.
...
## Write Impact
Verification/docs artifacts: YES; Product Code: NO
...
## Review Mapping
R02 FINAL_GATE or specific risk profile
