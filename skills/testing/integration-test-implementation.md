...
## Purpose
Run the `integration-test-implementation` procedure inside the permission and context of the calling agent.
...
## Write Impact
Test Code: conditional; Workspace artifacts: YES; Product Code: NO
...
## Review Mapping
R01 TEST_QUALITY or TEST_COVERAGE; R02 for contract/security/performance risk
