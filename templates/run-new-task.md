...
4. W01 creates `knowledge-context.md` and a version 2.1 profile-specific `skill-bundle.md` with concrete required skill files, `Bundle Validation Status: PENDING`, and detached validation evidence.
